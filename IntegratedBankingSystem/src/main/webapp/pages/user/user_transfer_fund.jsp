...
<body>
	...
	<form>
		<div>
			<label for="fromAcctNo">From Account Number: </label> <input
				type="text" name="fromAcctNo"
				placeholder="Enter From Account Number" required />
		</div>
		<div>
			<label for="toAcctNo">To Account Number: </label> <input type="text"
				name="toAcctNo" placeholder="Enter To Account Number" required />
		</div>
		<div>
			<label for="transferAmount">Transfer Amount: </label> <input
				type="number" name="transferAmount"
				placeholder="Enter Transfer Amount" required />
		</div>
		<div>
			<label for="transPwd">Transaction Password: </label> <input
				type="password" name="transPwd"
