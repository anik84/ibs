...
<link rel="stylesheet" type="text/css"
	href="/css/user_add_beneficiary.css">
</head>
...
<body>
	...
	<h2 id="welcomeText">Add Beneficiary.</h2>
	<form>
		<div>
			<label for="benefAcctNo">Account Number: </label> <input type="text"
				name="benefAcctNo" placeholder="Enter Account Number" required />
		</div>
		<div>
			<label for="benefName">Beneficiary Name: </label> <input
				type="number" name="benefName" placeholder="Enter Benef. Name"
				required />
		</div>
		<div>
			<label for="benefType" id="benefType">Beneficiary Type:</label> <select
				name="benefType">
